...
/// </summary>
public sealed class LaboratoryEntityProjectionSpec : BaseSpec<LaboratoryEntityProjectionSpec, Laboratory, Laboratory>
{
    /// <summary>
    /// Note that the specification projects the UserFile onto UserFileDTO together with the referenced User entity properties.
    /// </summary>
    protected override Expression<Func<Laboratory, Laboratory>> Spec => e => new()
    {
        Id = e.Id,
    ...
    public LaboratoryEntityProjectionSpec(Guid id) : base(id)
    {
    }

    public LaboratoryEntityProjectionSpec(string? search)
    {
