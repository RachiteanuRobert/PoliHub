...
namespace MobyLabWebProgramming.Infrastructure.Migrations
{
    ...
    [Migration("20230517134736_fix_student_subject")]
    partial class fix_student_subject
    {
            ...
            modelBuilder.Entity("SubjectsStudents", b =>
                {
                    b.HasOne("MobyLabWebProgramming.Core.Entities.Subject", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_SubjectsStudents_Subjects");
                    ...
                    b.HasOne("MobyLabWebProgramming.Core.Entities.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_SubjectsStudents_Users");
                });
