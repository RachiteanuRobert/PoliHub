...
/// </summary>
public class LaboratoryInstanceConfiguration : IEntityTypeConfiguration<LaboratoryInstance>
{
    public void Configure(EntityTypeBuilder<LaboratoryInstance> builder)
    {
