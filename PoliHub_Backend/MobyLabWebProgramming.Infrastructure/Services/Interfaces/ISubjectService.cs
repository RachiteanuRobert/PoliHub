...
public interface ISubjectService
{
    ...
    public Task<ServiceResponse> AddStudentToSubject(StudentToSubjectAddDTO studentSubjectIds, UserDTO? requestingUser, CancellationToken cancellationToken = default);
