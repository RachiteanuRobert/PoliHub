...
public interface ISubjectService
{
    ...
    public Task<ServiceResponse> AddUserToSubject(UserToSubjectDTO userSubjectIds, UserDTO? requestingUser, CancellationToken cancellationToken = default);
    public Task<ServiceResponse> DeleteUserFromSubject(Guid userSubjectId, UserDTO? requestingUser, CancellationToken cancellationToken = default);
