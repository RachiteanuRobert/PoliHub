...
public interface ILaboratoryService
{
    ...
    public Task<ServiceResponse> AddUserToLaboratory(UserToLaboratoryAddDTO userLaboratoryIds, UserDTO? requestingUser, CancellationToken cancellationToken = default);
