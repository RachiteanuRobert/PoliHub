...
public interface ICourseService
{
    ...
    public Task<ServiceResponse> AddStudentToCourse(StudentToCourseAddDTO studentCourseIds, UserDTO? requestingUser, CancellationToken cancellationToken = default);
