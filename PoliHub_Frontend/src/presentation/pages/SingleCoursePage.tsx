...
import AddCourseCourseInstanceButton from '@presentation/components/ui/Buttons/CourseCourseInstanceButtonAddButton';
import DeleteCourseUserButton from '@presentation/components/ui/Buttons/SubjectUserDeleteButton';
...
const getCourseRowValues = (entries: CourseDTO[] | null | undefined, orderMap: { [key: string]: number }) =>
    entries?.map(entry => {
        return {
            entry: entry,
            data: Object.entries(entry)
...
export const SingleSubjectPage = memo(() => {
    ...
    const courseInstances = course?.courseInstances;
