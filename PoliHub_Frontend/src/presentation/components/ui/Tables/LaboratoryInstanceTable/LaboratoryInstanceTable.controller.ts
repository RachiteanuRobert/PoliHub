 ...
 */
export const useLaboratoryInstanceTableController = (search: string) => {
    const { getLaboratoryInstances: { key: queryKey, query }, deleteLaboratoryInstance: { key: deleteLaboratoryInstanceKey, mutation: deleteLaboratoryInstance } } = useLaboratoryInstanceApi();
    ...
    const { mutateAsync: deleteMutation } = useMutation([deleteLaboratoryInstanceKey], deleteLaboratoryInstance); // Use a mutation to remove an entry.
