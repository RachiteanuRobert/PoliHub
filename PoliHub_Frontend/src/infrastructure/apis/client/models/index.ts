...
export * from './CourseInstanceUser';
...
export * from './JoinUserSimpleCourseDTO';
export * from './JoinUserSimpleCourseInstanceDTO';
export * from './JoinUserSimpleDTO';
export * from './JoinUserSimpleLaboratoryDTO';
export * from './JoinUserSimpleLaboratoryInstanceDTO';
export * from './JoinUserSimpleSubjectDTO';
